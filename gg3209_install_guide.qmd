...
::: {style="border-left: 4px solid #007BFF; padding: 10px; background-color: #f0f8ff;"}
Your python environment for the course GG3209 is now ready this part as complicated as it seems now will allow you to create and practice all your python skills., there are some steps you need to recall while you work on this course's labs. But with practice you will recall all of them with more and more practice.
:::
