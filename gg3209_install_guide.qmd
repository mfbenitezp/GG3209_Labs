...
<strong>Note:</strong> Make sure you have an stable internet connection. If you are using **eduroam** at the university, you might experience delays or issues when the internet connection isn't stable, if that is the case make sure you have a stable connection at home to complete this process properly.
:::
