...
**Estimated time to install:** [**40 minutes**.]{.underline}
...
flowchart TD
    A[Working Directory<br/>Your project files] --> B[git add]
...
# Step 0: Get familiar with the Command Prompt or Terminal.
...
2.  Click "Sign up"
3.  Choose a username
4.  Use your university email address ideally., but you can opt to use another email, just recall it when you need to recover your password.
...
There is a change you won't open GitHub to anything else than this course, but also there is another change where you will ended up working as spatial data scientist, or consultant into a collaborative and agile development team, in that case improving and configuring your GitHub account, as well as familiarizing yourself over how it works would be definitively beneficial for you. For instance there are lot of companies or institutions who are asking or expecting you to have some well curated repositories that prove your skills in GitHub. So take some time to enhance your profile bu adding this little extra information.
:::
