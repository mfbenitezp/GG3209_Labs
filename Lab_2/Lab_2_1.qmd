# Python Basics - Part 1 {.unnumbered}

[Open in Google Colab](https://colab.research.google.com/github/mfbenitezp/GG3209_Labs/blob/main/Lab_2/Lab_2_1.qmd)

::: callout-tip
## Practice Locally: Download the Jupyter Notebook

You can download a Jupyter notebook version of this lab to run and practice on your own computer using your local Python environment (gg3209).

**Instructions:** - Download the notebook using the link above. - Open it in JupyterLab or Jupyter Notebook (with your gg3209 environment activated). - Run and edit the code cells to practice Python as described in this lab.
:::
...
::: callout-important
All you need to do here, is read carefully each markdown cell, execute the code, see the results, and then complete any challenge included.
:::
...
## Comments (Important for clear coding)
...
Once you finish this, go to **Lab No2_Part2**, In that notebook, we will discuss more components of Python including functions, control flow, loops, modules, and reading data from disk.
:::
